...
| | 件数 |
| --- | --- |
| チーム | 1447(M-1 527 / M-2 223 / M-3 291 / M-4 223 / M-5 183) |
| メンバー | 8677 |
| 構築記事があるチーム | 1447 |
| 記事から個体情報が取れたチーム | 1180 |
| 記事があるのに何も取れなかったチーム | 267(x.com 111 / pokesol.app 43 / note.com 23 / YouTube 14 / 本文が画像のみ 等) |
| 個体情報が入ったメンバー | 6716(pokesol 2817 / LLM 3899) |
| 技が入ったメンバー | 6594 |
| 努力値が入ったメンバー | 4653 |
| 性格 / 特性が入ったメンバー | 5335 / 5166 |

「記事があるのに取れなかった267件」は**抽出の失敗ではない**。構築記事の多くは個体情報を
画像(スクリーンショット)で貼っており、本文テキストには数値が存在しない。
x.com 111件とYouTube 14件がその代表で、残りも本文が画像だけの記事。
...
努力値が4653件しか無いのは、記事が数値ではなく「HB:特化リザードンのニトロチャージ耐え」
...
(実測でも7件すべてが根拠の無い「ノーマル」だった)。落とした値は
...
実測 8677体すべて解決、うち2839体がメガストーン所持でメガ後の種族名になる。
